...
imgs = []
blankimg = ImageTk.PhotoImage(Image.open("/home/pi/dev/blank.jpg"))
for p in pics:
    print(p)
...
def process_turn(index):
    ...
    if index < 8:
        picfile = pics[firstpic+index][20:]
        print(f"image {picfile}")
        print([f"/home/pi/pyg2/bin/python /home/pi/dev/pgimage.py {picfile}"])
        subprocess.call([f"/home/pi/pyg2/bin/python /home/pi/dev/pgimage.py /home/pi/{picfile}"], shell=True)
    if index == 8:
        print("go next page")
